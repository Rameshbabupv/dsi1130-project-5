...
def two_d_plotter(vmean, i, j):
    ...
    c = '#fcba03'
    ax.bar(x1, hist1, zs=0, zdir='y', color='#fcba03', ec='#fcba03', alpha=0.8)
    ax.bar(x2, hist2, zs = 1, zdir = 'y', color = '#fcba03', ec = '#fcba03', alpha = 0.8)
    ax.bar(x3, hist3, zs=2, zdir='y', color='#fcba03', ec='#fcba03', alpha=0.8)
    ax.set_ylim(-1, 1)
    ax._axis3don = False
    ax.view_init(i, j)
